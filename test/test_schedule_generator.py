...
def generate_period_payload(divids ,perids ,docids):
...
def get_existing_cids_perids_docids():
...
def test_create_periods():
    ...
    count = 50
    divids ,perids ,docids = get_existing_cids_perids_docids()
    ...
    for _ in range(count):
        payload = generate_period_payload(divids ,perids ,docids)
